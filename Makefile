...
am_depmod_OBJECTS = depmod.$(OBJEXT) moduleops.$(OBJEXT) \
	tables.$(OBJEXT) zlibsupport.$(OBJEXT)
depmod_OBJECTS = $(am_depmod_OBJECTS)
depmod_LDADD = $(LDADD)
depmod_DEPENDENCIES =
am_insmod_OBJECTS = insmod.$(OBJEXT)
...
lsmod_LDADD = $(LDADD)
lsmod_DEPENDENCIES =
am_modinfo_OBJECTS = modinfo.$(OBJEXT) zlibsupport.$(OBJEXT)
modinfo_OBJECTS = $(am_modinfo_OBJECTS)
modinfo_LDADD = $(LDADD)
modinfo_DEPENDENCIES =
am_modprobe_OBJECTS = modprobe.$(OBJEXT) zlibsupport.$(OBJEXT)
modprobe_OBJECTS = $(am_modprobe_OBJECTS)
modprobe_LDADD = $(LDADD)
modprobe_DEPENDENCIES =
am_rmmod_OBJECTS = rmmod.$(OBJEXT)
rmmod_OBJECTS = $(am_rmmod_OBJECTS)
rmmod_LDADD = $(LDADD)
rmmod_DEPENDENCIES =
...
ACLOCAL = ${SHELL} /home/jcm/mit-dev/module-init-tools-3.3-pre3/missing --run aclocal-1.9
AMDEP_FALSE = #
AMDEP_TRUE = 
AMTAR = ${SHELL} /home/jcm/mit-dev/module-init-tools-3.3-pre3/missing --run tar
AUTOCONF = ${SHELL} /home/jcm/mit-dev/module-init-tools-3.3-pre3/missing --run autoconf
AUTOHEADER = ${SHELL} /home/jcm/mit-dev/module-init-tools-3.3-pre3/missing --run autoheader
AUTOMAKE = ${SHELL} /home/jcm/mit-dev/module-init-tools-3.3-pre3/missing --run automake-1.9
AWK = gawk
CC = gcc
...
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DPACKAGE_NAME=\"\" -DPACKAGE_TARNAME=\"\" -DPACKAGE_VERSION=\"\" -DPACKAGE_STRING=\"\" -DPACKAGE_BUGREPORT=\"\" -DPACKAGE=\"module-init-tools\" -DVERSION=\"3.3-pre2\" 
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/jcm/mit-dev/module-init-tools-3.3-pre3/missing --run makeinfo
MODULE_DIR = 
OBJEXT = o
...
infodir = ${prefix}/info
install_sh = /home/jcm/mit-dev/module-init-tools-3.3-pre3/install-sh
libdir = ${exec_prefix}/lib
libexecdir = ${exec_prefix}/libexec
localstatedir = ${prefix}/var
# If they haven't overridden mandir, fix it (never /man!)
mandir = $(shell if [ ${prefix}/man = $(prefix)/man ]; then if [ $(prefix) = / ]; then echo /usr/share/man; else echo $(prefix)/share/man; fi; else echo ${prefix}/man; fi)
mkdir_p = mkdir -p --
...
depmod$(EXEEXT): $(depmod_OBJECTS) $(depmod_DEPENDENCIES) 
	@rm -f depmod$(EXEEXT)
	$(LINK) $(depmod_LDFLAGS) $(depmod_OBJECTS) $(depmod_LDADD) $(LIBS)
...
modinfo$(EXEEXT): $(modinfo_OBJECTS) $(modinfo_DEPENDENCIES) 
	@rm -f modinfo$(EXEEXT)
	$(LINK) $(modinfo_LDFLAGS) $(modinfo_OBJECTS) $(modinfo_LDADD) $(LIBS)
modprobe$(EXEEXT): $(modprobe_OBJECTS) $(modprobe_DEPENDENCIES) 
	@rm -f modprobe$(EXEEXT)
	$(LINK) $(modprobe_LDFLAGS) $(modprobe_OBJECTS) $(modprobe_LDADD) $(LIBS)
rmmod$(EXEEXT): $(rmmod_OBJECTS) $(rmmod_DEPENDENCIES) 
	@rm -f rmmod$(EXEEXT)
	$(LINK) $(rmmod_LDFLAGS) $(rmmod_OBJECTS) $(rmmod_LDADD) $(LIBS)
...
include ./$(DEPDIR)/backwards_compat.Po
include ./$(DEPDIR)/depmod.Po
include ./$(DEPDIR)/insmod.Po
include ./$(DEPDIR)/lsmod.Po
include ./$(DEPDIR)/modinfo.Po
include ./$(DEPDIR)/modprobe.Po
include ./$(DEPDIR)/moduleops.Po
include ./$(DEPDIR)/moduleops_core.Po
include ./$(DEPDIR)/rmmod.Po
include ./$(DEPDIR)/tables.Po
include ./$(DEPDIR)/zlibsupport.Po
...
distdir: $(DISTFILES)
	$(am__remove_distdir)
	mkdir $(distdir)
	$(mkdir_p) $(distdir)/doc $(distdir)/tests
...
installdirs:
	for dir in "$(DESTDIR)$(bindir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(sbindir)" "$(DESTDIR)$(man5dir)" "$(DESTDIR)$(man8dir)"; do \
...
.PHONY: CTAGS GTAGS all all-am am--refresh check check-TESTS check-am \
	clean clean-binPROGRAMS clean-generic clean-sbinPROGRAMS ctags \
